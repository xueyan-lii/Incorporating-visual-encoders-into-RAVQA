...
local instructBLIP_embeddings = {
  "train": "../data/ok-vqa/pre-extracted_features/blip2_head_embeddings/coco_instructblip_qformer_train2014.pkl",
...
local in_context_examples = {
  "file_path": "/home/xl544/rds/hpc-work/Retrieval-Augmented-Visual-Question-Answering/data/ok-vqa/pre-extracted_features/in_context_examples/rices_concat_a1b1_normalized_text_promptcap_iblip.pkl",
};
{
  "DATA_FOLDER": "",
  "EXPERIMENT_FOLDER": "",
      ...
      "module_dict":{   // all available modules
        ...
        "LoadClipEmbeddings": {
          ...
          "config": {
            ...
            "instructBLIP_embeddings": instructBLIP_embeddings, 
          },
        },
        "LoadOKVQAData": {
